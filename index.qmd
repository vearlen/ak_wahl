...
```
The open, rather rhetorical question I have is:

```{=html}
<b><big>In case everybody vote for socialists to protect herself as an employee why people vote for other parties during parliament elections?</big></b><br>
```
```{=html}
